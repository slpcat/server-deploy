...
variable "ami_description" {
  type    = string
  default = "EKS Kubernetes Worker AMI with AmazonLinux2 image by slpcat"
}

variable "ami_name" {
  type = string
  default = "amazonlinux2-eks-{{timestamp}}"
}
...
variable "source_ami_filter_name" {
  type    = string
  default = "amazon-eks-node-1.20-v2021*"
}
...
build {
  ...
  provisioner "shell" {
    expect_disconnect = false
    timeout = "30m"
    script  = "../scripts/docker-images.sh"
  }
