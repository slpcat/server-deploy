...
variable "ami_description" {
  type    = string
  default = "EKS Kubernetes Worker AMI with Ubuntu 2004 arm64 image by slpcat"
}

variable "ami_name" {
  type = string
  default = "ubuntu2004-eks-arm64-{{timestamp}}"
}
...
variable "source_ami_filter_name" {
  type    = string
  default = "ubuntu-eks/k8s_1.20/images/hvm-ssd/ubuntu-focal-20.04-arm64-server-2021*"
}
...
build {
  ...
  provisioner "ansible-local" {
    role_paths    = [
      "../roles/init-node-ubuntu2004"
    ]
    group_vars    = "../group_vars"
    playbook_dir  = "../playbooks"
    playbook_file = "../playbooks/init-node-ubuntu2004-aws.yml"
    #inventory_groups =
    #command =
    extra_arguments = [
      "-b -v"
