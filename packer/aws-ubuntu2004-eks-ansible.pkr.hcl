...
variable "ami_description" {
  type    = string
  default = "EKS Kubernetes Worker AMI with Ubuntu 2004 image by slpcat"
}

variable "ami_name" {
  type = string
  default = "ubuntu2004-eks-{{timestamp}}"
}
...
variable "source_ami_filter_name" {
  type    = string
  default = "ubuntu-eks/k8s_1.20/images/hvm-ssd/ubuntu-focal-20.04-amd64-server-2021*"
}
